...
REInput_path = fullfile(cd,'re-input');
REOutput_path = fullfile(cd,'re-output');
...
qualificationPlan = fullfile(cd,'Input','master_quali_plan.json');
...
ReportOutput_path= fullfile(cd,'report-output');
